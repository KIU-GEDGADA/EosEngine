...
public class Vector3fTest {
    ...
    @Test
    void testZero() {
        assertEquals(new Vector3f(0, 0, 0), Vector3f.zero());
    }

    @Test
    void testOne() {
        assertEquals(new Vector3f(1, 1, 1), Vector3f.one());
    }

    @Test
    void testUp() {
        assertEquals(new Vector3f(0, 1, 0), Vector3f.up());
    }

    @Test
    void testDown() {
        assertEquals(new Vector3f(0, -1, 0), Vector3f.down());
    }

    @Test
    void testLeft() {
        assertEquals(new Vector3f(-1, 0, 0), Vector3f.left());
    }

    @Test
    void testRight() {
        assertEquals(new Vector3f(1, 0, 0), Vector3f.right());
    }

    @Test
    void testForward() {
        assertEquals(new Vector3f(0, 0, -1), Vector3f.forward());
    }

    @Test
    void testBackward() {
        assertEquals(new Vector3f(0, 0, 1), Vector3f.backward());
    }
}
