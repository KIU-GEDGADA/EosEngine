...
by [**Kutaisi International University**](https://kiu.edu.ge) students as a part of the university course "Basic Game Engine Development".

## Installation

Before continuing, you will need the following:

- [git](https://git-scm.com/) installed on the computer
- Java IDE (Example: [IntelliJ IDEA](https://www.jetbrains.com/idea/), [Eclipse IDE](https://www.eclipse.org/ide/))
- \*Dependencies that are needed, will be installed automaticlly when you will build the project

Install EosEngine with git:

- Click "CODE" in the top right corner of the github page, then click
  "HTTPS". Go ahead and copy the link which should
  look something like this: `https://github.com/KIU-GEDGADA/EosEngine.git`
...
If you want to modify the camera settings, you can do the following:
...
A `Model` holds a `Texture` and a `Mesh`. It makes sure to attach those objects together.
